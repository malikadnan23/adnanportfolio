      ...
      >
        ...
        >
          <p className="mb-10 max-w-2xl font-Ovo">
            ...
            MERN Stack, React Native, and WordPress development. Skilled in
            building dynamic web apps using React, Node.js, Express, and
            MongoDB, and developing cross-platform mobile apps with React
            Native. Experienced in creating and customizing responsive WordPress
            websites.{" "}
          </p>
          <motion.ul
            initial={{ opacity: 0 }}
          ...
          >
            {toolsData.map((tool, index) => (
              <motion.li
                key={index}
                className="flex items-center  justify-center w-12 sm:w-14 aspect-square border border-gray-400 hover:bg-[#fcf4ff] hover:-translate-y-1 duration-500 rounded-lg cursor-pointer"
              >
